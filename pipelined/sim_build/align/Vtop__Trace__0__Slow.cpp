...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->pushPrefix("align", VerilatedTracePrefixType::SCOPE_MODULE);
    ...
    tracep->declBus(c+6,0,"funct3",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBus(c+7,0,"addr",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+2,(vlSelfRef.funct3),3);
    bufp->fullCData(oldp+3,(vlSelfRef.addr),2);
    bufp->fullIData(oldp+4,(vlSelfRef.y),32);
    bufp->fullIData(oldp+5,(vlSelfRef.align__DOT__a),32);
    bufp->fullCData(oldp+6,(vlSelfRef.align__DOT__funct3),3);
    bufp->fullCData(oldp+7,(vlSelfRef.align__DOT__addr),2);
    bufp->fullIData(oldp+8,(vlSelfRef.align__DOT__y),32);
}
