...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+9,0,"wd",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+10,0,"rd",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+11,0,"index",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 5,0);
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+2,(vlSelfRef.we));
    bufp->fullIData(oldp+3,(vlSelfRef.a),32);
    bufp->fullIData(oldp+4,(vlSelfRef.wd),32);
    bufp->fullIData(oldp+5,(vlSelfRef.rd),32);
    bufp->fullBit(oldp+6,(vlSelfRef.dmem__DOT__clk));
    bufp->fullBit(oldp+7,(vlSelfRef.dmem__DOT__we));
    bufp->fullIData(oldp+8,(vlSelfRef.dmem__DOT__a),32);
    bufp->fullIData(oldp+9,(vlSelfRef.dmem__DOT__wd),32);
    bufp->fullIData(oldp+10,(vlSelfRef.dmem__DOT__rd),32);
    bufp->fullCData(oldp+11,(vlSelfRef.dmem__DOT__index),6);
}
