...
void Vtop___024root___eval_triggers__act(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.__VactTriggered.setBit(2U, ((IData)(vlSelfRef.toplevel__DOT__mips_core__DOT__alucontrol) 
                                          != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__toplevel__DOT__mips_core__DOT__alucontrol__0)));
    vlSelfRef.__VactTriggered.setBit(3U, (vlSelfRef.toplevel__DOT__mips_core__DOT__datapath_inst__DOT__alumuxout 
                                          != vlSelfRef.__Vtrigprevexpr___TOP__toplevel__DOT__mips_core__DOT__datapath_inst__DOT__alumuxout__0));
    vlSelfRef.__VactTriggered.setBit(4U, (vlSelfRef.toplevel__DOT__mips_core__DOT__datapath_inst__DOT__regout1 
                                          != vlSelfRef.__Vtrigprevexpr___TOP__toplevel__DOT__mips_core__DOT__datapath_inst__DOT__regout1__0));
    vlSelfRef.__VactTriggered.setBit(5U, (vlSelfRef.toplevel__DOT__mips_core__DOT__datapath_inst__DOT__alu__DOT__y 
